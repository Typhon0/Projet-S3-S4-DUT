...
public class Tuile {
    ...
    /**
     * Cette méthode equals est utilisée pour la détection de la tuile touchée lors du déplacement du voleur.
     * On compare donc le pixel touché avec la tuile this
     *
     * @param v Vector2 qui a été touché pour déplacer le joueur
     * @return boolean s'il correspond à la tuile ou non
     */
